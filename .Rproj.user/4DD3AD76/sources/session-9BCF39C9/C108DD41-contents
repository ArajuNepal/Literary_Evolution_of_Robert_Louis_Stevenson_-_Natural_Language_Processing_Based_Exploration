...
pacman::p_load(gutenbergr, dplyr, tidytext, stringr, SnowballC, textstem, ggplot2, forcats, 
               tidyr, textdata, tokenizers, topicmodels, tm, ldatuning, xtable, ggwordcloud)
...
ggsave("visualisations/proportion_of_each_topic_visualisation.eps", plot = proportion_of_each_topic_visualisation, width = 6, height = 6, dpi = 300)
